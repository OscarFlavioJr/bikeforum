...
class BikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bike" do
    assert_difference("Bike.count") do
      post bikes_url, params: { bike: { \: @bike.\, brand: @bike.brand, model: @bike.model, style: @bike.style, year: @bike.year } }, as: :json
    end
  ...
  test "should update bike" do
    patch bike_url(@bike), params: { bike: { \: @bike.\, brand: @bike.brand, model: @bike.model, style: @bike.style, year: @bike.year } }, as: :json
    assert_response :success
  end
